...
{
    public class RightToLeftPullToLoadMoreDemoScript : MonoBehaviour
    {
        public LoopListView2 mLoopListView;
        LoadingTipStatus mLoadingTipStatus = LoadingTipStatus.None;
        float mLoadingTipItemWidth = 150;
        ...
        void UpdateLoadingTip(LoopListViewItem2 item)
        {
            ...
            if (mLoadingTipStatus == LoadingTipStatus.None)
            {
                ...
                item.CachedRectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, 0);
            }
            else if (mLoadingTipStatus == LoadingTipStatus.WaitRelease)
            {
                ...
                item.CachedRectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, mLoadingTipItemWidth);
            }
