...
public class BinarySerializeHelper
{
    ...
    public static MemoryStream InstanceDataToMemory<T>(T obj)
    {
        // 参数检查
        ...
        {
            // 将对象序列化之后传入流中
            binaryFormatter.Serialize(memoStream, obj);
            return memoStream;
        }
        catch (Exception e)
        {
    ...
    public static void InstanceDataToFile<T>(T obj, string filepath, bool isAppend = false)
    {
        // 参数判断
        if (filepath == null)
