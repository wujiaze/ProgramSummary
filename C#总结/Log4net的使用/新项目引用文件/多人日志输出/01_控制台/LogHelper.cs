 ...
 *                   2、在 log4net.config 中 添加 新的记录器
 *                   3、在 log4net.config 中，添加自定义的显示控制台的形式
 */
...
namespace LogDemo1
{
    ...
    {
        private static System.Collections.Generic.Dictionary<LogPeople, log4net.ILog> dictLogger;
        ...
        static LogHelper()
        {
            ...
            dictLogger = new System.Collections.Generic.Dictionary<LogPeople, log4net.ILog>();
