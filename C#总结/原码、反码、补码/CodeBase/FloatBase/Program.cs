...
namespace FloatBase
{
    class Program
    {
        ...
        private static void ComfirmFloat()
        {
            ...
            //      底数：由于每一个底数的最左侧都是整数1，所以为了节省空间，就不存储，得到底数是 1 0110 0110 0110 0110 0110 0110 0110 0110 0110 ......，然后右侧截取23位 1 0110 0110 0110 0110 0110 01 右侧为1，需要进位，最终 1 0110 0110 0110 0110 0110 10
            // 步骤3、
            //      判断符号位 正为0 负为1
            // 步骤4、
